						...
						<button class="close" data-dismiss="modal" type="button">&times;</button>
							<div class="modal-body">
								...
								<div class="container" style="width: 100%">
									<form action="addStock.php" class="custom-form-horizontal" data-toggle="validator" method="post" role="form">
                          ...
                          <label>Stock Image: </label>
													...
													<input type="file" name="stockImage" id="fileToUpload" class="form-control1 control3">
													<br>
													<center>
