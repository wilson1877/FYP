...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 14, 2018 at 11:12 AM
...
(20, 15, 1, '0.00', '696.00', '2018-11-14', ''),
(21, 16, 1, '0.00', '2400.00', '2018-11-14', ''),
(22, 17, 1, '0.00', '8800.00', '2018-11-14', ''),
(23, 18, 9, '0.00', '700.00', '2018-11-14', ''),
(24, 19, 9, '0.00', '720.00', '2018-11-14', ''),
(25, 20, 9, '0.00', '7700.00', '2018-11-14', ''),
(26, 21, 8, '0.00', '1500.00', '2018-11-14', '');
...
(7, '2018-10-02', '3000.00', 0, 1, '', 'SAY-2111', 0),
...
(15, '2018-11-13', '696.00', 0, 1, '', 'PS-14', 0),
(16, '2018-11-14', '2400.00', 0, 1, '', '1111', 0),
(17, '2018-11-14', '3000.00', 0, 1, '121', 'KEK-PLASa', 0),
(18, '2018-11-14', '700.00', 0, 9, '', 'Test111', 0),
(19, '2018-11-14', '8400.00', 0, 9, '', '121', 0),
(21, '2018-11-14', '1500.00', 0, 8, '', 'aa', 0);
...
CREATE TABLE `prediction` (
  ...
  `averageDays` int(11) NOT NULL,
  `averageQuantity` int(11) NOT NULL,
  `nextPurchase` date NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `prediction` (`customerID`, `stockID`, `averageDays`, `averageQuantity`, `nextPurchase`) VALUES
(1, 4, 21, 14, '2018-12-05'),
(6, 4, 0, 5, '2018-10-02'),
(8, 2, 0, 3, '2018-10-02'),
(8, 5, 43, 6, '2018-12-27'),
(9, 1, 0, 6, '2018-11-14');
...
CREATE TABLE `settings` (
  `ID` int(100) NOT NULL,
  `predictionsetting` int(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `settings` (`ID`, `predictionsetting`) VALUES
(1, 45);
...
(1, 'images/stockUpload/20170424042023_20130415045738floatglass.jpg', 'HONSBERG VISION M42 in coil 30m', '700.00', 467),
(2, 'images/stockUpload/dowel.png', 'M42 High Speed Steel Bi-Metal', '60.00', 477),
(3, 'images/stockUpload/DSC_1218.jpg', 'HONSBERG EXTRA M42 High Speed Steel Bi-Metal', '58.00', 271),
(4, 'images/stockUpload/nitrile-rubber-sheet.jpg', 'HONSBERG DURATEC M51 High Speed Steel Bi-Metal	', '200.00', -33),
(5, 'images/stockUpload/plastic-sheet-supplier.jpg', 'HONSBERG SPECTRA M42 High Speed Steel Bi-metal', '150.00', 102);
...
ALTER TABLE `prediction`
  ADD PRIMARY KEY (`customerID`,`stockID`);
...
--
ALTER TABLE `invoiceitemlist`
  MODIFY `itemListID` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;
